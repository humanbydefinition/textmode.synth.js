...
export interface ISynthSource {
     ...
     *
     * @param output - Optional output reference from another layer
     *
     * @example
     * ```typescript
     ...
     * ```
     */
    src?: (output?: SynthParameterValue) => ISynthSource;
    /**
     * Sample the previous frame's primary color output for feedback effects.
     ...
     * ```
     */
    charSrc?: (output?: SynthParameterValue) => ISynthSource;
    /**
     ...
     * ```
     */
    cellColorSrc?: (output?: SynthParameterValue) => ISynthSource;
    /**
     * Rotate coordinates.
