# Contributing to `textmode.synth.js`

Thank you for helping improve `textmode.synth.js`.
...
compiler or shader architecture, packaging, browser support, or bundled assets in an issue before implementation.
